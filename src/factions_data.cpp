...
namespace faction_data
{
    ...
    inline void Faction<FactionType>::set_score(ExpandedScore newScore) {
        write_bits<ExpandedScore, kScoreOffset, kScoreBits>();
    }
